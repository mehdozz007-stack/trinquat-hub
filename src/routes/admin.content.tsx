      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setEditorOpen({} as EventRow)} className="inline-flex items-center gap-1.5 rounded-full bg-gradient-leaf px-4 py-2 text-xs font-semibold text-primary-foreground shadow-soft hover:shadow-glow">
        ...
        {loadingEvents ? (
          ...
          <EmptyState label="Aucun événement pour le moment." onCreate={() => setEditorOpen({} as EventRow)} />
        ) : (
          <ContentTable
            rows={events.map((e) => ({
