      ...
      <section id="events-preview" className="relative bg-secondary/70 py-12 md:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          {upcomingEvents.length > 0 ? (
                ...
                <Reveal key={e.title} delay={i * 0.08}>
                  <article className="group relative h-full overflow-hidden rounded-3xl bg-card border border-border/70 transition-all duration-500 hover:-translate-y-1 hover:shadow-elegant">
                    ...
                    <div className="p-7">
                      ...
                      <Link
                        to="/contact"
                        className="mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-primary-deep group/link"
                      >
                        Je participe
            ...
            <Reveal>
              <div className="py-16 text-center bg-card/50 border border-border/70 rounded-3xl">
