...
const floatingIcons = [
  ...
  { Icon: Leaf, top: "75%", left: "5%", delay: 0.5, duration: 8 },
  { Icon: Heart, top: "35%", right: "12%", delay: 1, duration: 7 },
  { Icon: Sparkles, top: "70%", right: "8%", delay: 1.5, duration: 6.5 },
            ...
            <div className="lg:col-span-2 relative overflow-hidden">
              ...
              >
                ...
                <p className="mt-6 text-base leading-relaxed opacity-90 max-w-xs">
                  Rejoignez les habitants qui font vivre le quartier. Chaque voisin apporte sa pierre à l'édifice.
                </p>
